            ...
            {hasActiveSubscription && (
              <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/50 overflow-hidden">
                ...
                <div className="p-6 space-y-3">
                  <button
                    onClick={handleUpgrade}
                    className="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-medium rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-200 shadow-md hover:shadow-lg"
                  >
          ...
          <div className="lg:col-span-8">
            {showPlans || needsSubscription ? (
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900">
                      {needsSubscription ? 'Chọn gói subscription' : 'Nâng cấp gói'}
                    </h2>
                    <p className="text-sm text-gray-600 mt-1">
                      {needsSubscription ? 
                        'Chọn gói phù hợp để bắt đầu sử dụng dịch vụ' : 
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/50 overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
                    <h2 className="text-lg font-semibold text-white">Chi tiết subscription</h2>
                  </div>
                  <div className="p-6">
                    <SubscriptionStatus showDetails={true} compact={false} />
                  </div>
